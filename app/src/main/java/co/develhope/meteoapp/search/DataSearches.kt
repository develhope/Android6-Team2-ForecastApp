...
sealed class DataSearches(val type: Int) {
    ...
    data class ItemSearch(val recentCitySearch: String, val admin1: String?, val longitude : Double?, val latitude : Double?) : DataSearches(
        itemSearchId){ override fun toString(): String {
